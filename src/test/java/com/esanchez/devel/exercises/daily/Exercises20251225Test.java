...
public class Exercises20251225Test {

	private static final Exercises20251225 exercises20251225 = new Exercises20251225();
	...
	void validateSortArray() {
		...
		int[] result1 = exercises20251225.sortArray(input1);
		int[] result2 = exercises20251225.sortArray(input2);
	...
	void validateSortArrayWithStream() {
		...
		int[] result1 = exercises20251225.sortArrayWithStream(input1);
		int[] result2 = exercises20251225.sortArrayWithStream(input2);
